...
function Contact() {
  ...
  const submit = (e: React.FormEvent) => {
    e.preventDefault()
    // No backend here — hand off to the visitor's mail client with the form pre-filled.
    const subject = encodeURIComponent(`Automation enquiry from ${name || 'a visitor'}`)
            ...
            <div>
              ...
              <form onSubmit={submit} style={{ display: 'grid', gap: '0.8rem' }}>
                ...
                <div style={{ marginTop: '0.4rem' }}>
                  <CyanButton type="submit">Send enquiry</CyanButton>
                </div>
              </form>
            </div>
